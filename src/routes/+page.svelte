...
<div class="mx-8 lg:mx-16">
	<div class="mt-4 md:mt-8 lg:mt-16 text-center">
	...
	<div class="flex flex-row flex-wrap justify-center mt-4 md:mt-8">
		...
		<HomeCard href="/cv" text="view my CV" bg="bg-warning-100">
			<div class="grid grid-cols-5 gap-2 md:gap-4">
				<div />
				<div class="bg-secondary-500 col-span-3" />
				<div />
			</div>
			...
			<div class="grid grid-cols-8 gap-2">
				...
				<div class="bg-secondary-800 col-span-2 md:mr-1" />
				<div class="bg-secondary-500 col-span-4"/>
			</div>
			<div class="grid grid-cols-8 gap-2">
				<div class="bg-secondary-500" />
				<div class="bg-secondary-800 col-span-2 md:mr-1" />
				<div class="bg-secondary-500 col-span-5"/>
			</div>
		</HomeCard>
	</div>
</div>
